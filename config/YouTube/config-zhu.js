...
var config = {
    ...
    modules: [
        ...
        },
        {
            ...
            position: "top_center",
            config: {
              playlist: "PLh3A0cnoWYsyGnl2aSitB1RBG7TGI94Su",
              autoplay: true,
              controls: false,
              loop: true,
              modestbranding: true,
        ...
        },
        {
            ...
            config: {
                url: [
                      "https://en.wikipedia.org/wiki/Zhu_(musician)",
                      "https://en.wikipedia.org/wiki/Ringos_Desert",
                      "https://en.wikipedia.org/wiki/Generationwhy",
                     ],
