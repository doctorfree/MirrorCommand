...
var config = {
    ...
    modules: [
        ...
        },
        {
            ...
            position: "top_center",
            config: {
              playlist: "PLh3A0cnoWYsxtAiM03iCFttCyYyk1mju2",
              autoplay: true,
              controls: false,
              loop: true,
              modestbranding: true,
        ...
        },
        {
            ...
            config: {
                url: [
                      ...
                      "https://www.blacktapeproject.com/pages/about-the-black-tape-project",
                      "https://www.the-sun.com/news/4682253/black-tape-project-models-sticky-tape-catwalk/",
                     ],
