...
//	address: "localhost",
    ...
    modules: [
        ...
        },
        {
            ...
            config: {
                imagePaths: [
                    '/usr/local/MirrorCommand/pics/Models/River/',
                    '/usr/local/MirrorCommand/pics/Models/Shower/',
                    '/usr/local/MirrorCommand/pics/Models/Underwater/',
                    '/usr/local/MirrorCommand/pics/Models/Waterfall/',
                ],
